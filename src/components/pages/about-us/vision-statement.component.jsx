...
const VisionStatement = () => {
    return (
        <div className="w-full lg:mt-[120px] mt-[4em] px-[1em] lg:px-[120px] relative" >
            <div className="w-full flex flex-col lg:flex-row items-start justify-between h-full relative">
                <div className="lg:w-[50%] h-full" >
                    <h1 className=" lg:text-[40px] text-[30px] font-moon font-bold">
                        Vision <span className=" text-gray-500 ">Statement</span>
                    </h1>
                </div>
                <div className="lg:w-[50%] flex items-end h-full relative lg:mt-[50px] mt-[2em]">
