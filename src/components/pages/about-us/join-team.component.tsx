...
const JoinTheTeam = () => {
    return (
        <div className="w-full lg:mt-[120px] px-[2em] lg:px-[120px] relative mt-[3em]" >
            <div className="w-full flex flex-col lg:flex-row  items-start justify-between h-full relative">
                ...
                <div className="lg:w-[40%] flex flex-col items-end h-full relative ">
                    <P className="  text-[#1E1E1E] leading-[23px] lg:text-[18px] font-kiona lg:mt-[80px] mt-[2em]">
                    ...
                    <div className="w-full mt-[2em] lg:mt-[89px] flex items-center justify-center lg:justify-end gap-[12px]  " >
